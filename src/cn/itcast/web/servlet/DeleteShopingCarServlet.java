    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
               ...
               DeletShopingDao  deletShopingDao = new DeletShopingDao();
                ...
                if (result){
                    ...
                    response.getWriter().write("<script>alert('删除成功，请继续购物');window.location.href='/phone_war_exploded/ShopingCar.jsp';</script>");

                }else{
                    response.setContentType("text/html;charset=utf8");
                    response.getWriter().write("<script>alert('删除失败，请稍后重试');window.location.href='/phone_war_exploded/ShopingCar.jsp';</script>");
