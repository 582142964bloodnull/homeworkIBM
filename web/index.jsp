...
<html>
  ...
  <%
      ...
      %>
  <div class="dingbu">
  <h1 text-align:center  >Kegis™手机游戏商城</h1><br></div>
  <div class="dingxia">
  <div class="dingxia1">
  <a href="/phone_war_exploded/register.html">注册</a>
  <a>&nbsp;&nbsp;</a>
  <a href="/phone_war_exploded/login.html">登陆</a></div>
  <a href="/phone_war_exploded/SignOutServlet">
  ...
  <div class="gongneng">
      ...
      <div style=" text-align:center;background:  #183D58;margin-top: 5px;margin-bottom: 5px;margin-left:5px; margin-right:5px"><p><a href="/phone_war_exploded/ShopingCar.jsp" >购物车</a></p><br></div>
      <div style=" text-align:center;background:  #183D58;margin-top: 5px;margin-bottom: 5px;margin-left:5px; margin-right:5px"><p><a href="/phone_war_exploded/list.jsp">所有游戏</a></p><br></div>
          <div style=" text-align:center;background: #183D58;margin-top: 5px;margin-bottom: 5px;margin-left:5px; margin-right:5px"><p><a href="FinePhone.jsp">查询游戏</a></p><br></div>
