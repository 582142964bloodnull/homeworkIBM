...
<%
        ...
        if (username == null){
            out.print("<script>alert('你还未登陆，无法查看购物车');window.location.href='/phone_war_exploded/index.jsp';</script>");
        }
        else{
    ...
    <table border="1" class="table table-bordered table-hover">
      ...
      {           Map userMap= (Map) shopCarList.get(i);%>
        <tr>
            ...
            <td><a class="btn btn-default btn-sm" href="/phone_war_exploded/DeleteShopingCarServlet?orderId=<% out.print(userMap.get("orderId")); %>">删除商品</a>&nbsp&nbsp&nbsp<a class="btn btn-default btn-sm">结算</a></td>
        </tr>
        <% } %>
