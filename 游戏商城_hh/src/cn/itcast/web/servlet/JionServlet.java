...
public class JionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (username != null) {
            ...
            String gameLog = request.getParameter("gameLog");
            int gamePrice = new  Integer(request.getParameter("game_price"));
            JoinDao joinDao = new JoinDao();
            boolean result = joinDao.Join(username,shopId,gameName,gameLog,gamePrice);
            if(result){
