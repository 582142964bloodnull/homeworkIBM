...
CREATE TABLE `orders`  (
  ...
  `game_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `game_log` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `game_price` int(255) NULL DEFAULT NULL,
...
CREATE TABLE `game`  (
  ...
  `game_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `game_log` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `game_cpu` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `game_screen` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `game_price` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `game_charge` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
-- Records of game
-- ----------------------------
INSERT INTO `game` VALUES (1, '傻妞', '华人牌', '麒麟999999', '真人模式', '99999999', '100000w光能充电');
INSERT INTO `game` VALUES (2, '太子', '太子牌', '高通666666', '全息投影', '88888888', '100000w快充');
INSERT INTO `game` VALUES (3, '风暴', '太子牌', '麒麟888888', '全息投影', '66666666', '100000w快充');
