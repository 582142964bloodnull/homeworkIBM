...
<div class="container">
    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td><% out.print(userMap.get("game_age")); %></td>
            <td><% out.print(userMap.get("game_memory")); %></td>
            <td><%out.print(userMap.get("game_price")); %></td>
            <td><%out.print(userMap.get("game_type")); %></td>
            <td><a class="btn btn-default btn-sm" href="/game_war_exploded/JionServlet?gameName=<% out.print(userMap.get("game_name")); %>&gameplat=<% out.print(userMap.get("game_plat")); %><% out.print(userMap.get("game_plat")); %>&shopId=<% out.print(userMap.get("game_id")); %>&game_price=<% out.print(userMap.get("game_price")); %>">加入购物车</a></td>
        </tr>
        <% } %>
